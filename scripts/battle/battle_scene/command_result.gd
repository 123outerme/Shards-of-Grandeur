...
@export var lifestealHeal: int = 0
@export var selfHpSacrificed: int = 0
...
func _init(
	...
	i_lifestealHeal: int = 0,
	i_selfHpSacrificed: int = 0,
):
	...
	lifestealHeal = i_lifestealHeal
	selfHpSacrificed = i_selfHpSacrificed
