...
- `gtl_1.mp3`: By iPhoenix.
- `gtl_3.mp3`: By iPhoenix.
- `gtl_4.mp3`: By Ian Groat.
...
- `grandstone.mp3`: By Henry Guckes.
- `hilltop_forest.mp3`: By Henry Guckes.
- `leavenport.mp3`: By Austin Greenlee.
- `quarry_intro.mp3`: By Henry Guckes.
- `quarry_loop.mp3`: By Henry Guckes.
